...
const allTeachersProvider = AllTeachersProvider._();

final class AllTeachersProvider
    extends
        $FunctionalProvider<
          AsyncValue<List<TeacherData>>,
          List<TeacherData>,
          FutureOr<List<TeacherData>>
        >
    with
        $FutureModifier<List<TeacherData>>,
        $FutureProvider<List<TeacherData>> {
  const AllTeachersProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
  ...
  @override
  String debugGetCreateSourceHash() => _$allTeachersHash();

  @$internal
  @override
  $FutureProviderElement<List<TeacherData>> $createElement(
    $ProviderPointer pointer,
  ) => $FutureProviderElement(pointer);

  @override
  FutureOr<List<TeacherData>> create(Ref ref) {
    return allTeachers(ref);
  }
}

String _$allTeachersHash() => r'c07b6a74476ae222c9e7774256b16521b8668d44';

@ProviderFor(insiderTeacherIds)
const insiderTeacherIdsProvider = InsiderTeacherIdsProvider._();

final class InsiderTeacherIdsProvider
    extends
        $FunctionalProvider<
          AsyncValue<List<int>>,
          List<int>,
  ...
  const InsiderTeacherIdsProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'insiderTeacherIdsProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$insiderTeacherIdsHash();
  ...
  FutureOr<List<int>> create(Ref ref) {
    return insiderTeacherIds(ref);
  }
}

String _$insiderTeacherIdsHash() => r'54d8a1e7ac9e8d126cdded8c165fac7eea556f2e';
...
final class TeacherByIdProvider
    extends
        ...
        >
    with $FutureModifier<TeacherData?>, $FutureProvider<TeacherData?> {
  ...
  @$internal
  @override
  $FutureProviderElement<TeacherData?> $createElement(
    $ProviderPointer pointer,
  ) => $FutureProviderElement(pointer);

  @override
  FutureOr<TeacherData?> create(Ref ref) {
...
String _$teacherByIdHash() => r'60230e91ba985aa6a7e6b4a913dce12f2ce541ee';

final class TeacherByIdFamily extends $Family
    with $FunctionalFamilyOverride<FutureOr<TeacherData?>, int> {
...
@ProviderFor(teachersByIds)
const teachersByIdsProvider = TeachersByIdsFamily._();

final class TeachersByIdsProvider
    extends
        $FunctionalProvider<
          AsyncValue<List<TeacherData>>,
          List<TeacherData>,
    ...
    with
        $FutureModifier<List<TeacherData>>,
        $FutureProvider<List<TeacherData>> {
  const TeachersByIdsProvider._({
    required TeachersByIdsFamily super.from,
    required List<int> super.argument,
  }) : super(
         retry: null,
         name: r'teachersByIdsProvider',
         isAutoDispose: true,
         dependencies: null,
         $allTransitiveDependencies: null,
       );
  ...
  @override
  String debugGetCreateSourceHash() => _$teachersByIdsHash();

  @override
  String toString() {
    return r'teachersByIdsProvider'
        ''
        '($argument)';
  }
  ...
  FutureOr<List<TeacherData>> create(Ref ref) {
    ...
    return teachersByIds(ref, argument);
  }

  @override
  bool operator ==(Object other) {
    return other is TeachersByIdsProvider && other.argument == argument;
  }
...
String _$teachersByIdsHash() => r'a3c9582e20c678cbdb043a6c24949f87c55bcc9c';

final class TeachersByIdsFamily extends $Family
    with $FunctionalFamilyOverride<FutureOr<List<TeacherData>>, List<int>> {
  const TeachersByIdsFamily._()
    : super(
        retry: null,
        name: r'teachersByIdsProvider',
        dependencies: null,
  ...
  TeachersByIdsProvider call(List<int> ids) =>
      TeachersByIdsProvider._(argument: ids, from: this);

  @override
  String toString() => r'teachersByIdsProvider';
}

@ProviderFor(insiderTeachers)
const insiderTeachersProvider = InsiderTeachersProvider._();

final class InsiderTeachersProvider
    extends
        $FunctionalProvider<
          AsyncValue<List<TeacherData>>,
          List<TeacherData>,
    ...
    with
        $FutureModifier<List<TeacherData>>,
        $FutureProvider<List<TeacherData>> {
  const InsiderTeachersProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'insiderTeachersProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$insiderTeachersHash();
  ...
  @override
  FutureOr<List<TeacherData>> create(Ref ref) {
    return insiderTeachers(ref);
  }
}

String _$insiderTeachersHash() => r'b1a498088ed36c9be64d612120a3de340219676f';
...
String _$allPhdCohortsHash() => r'382f82882e67f1c0c31e095cd31211802eb66751';

@ProviderFor(myDriftDatabase)
const myDriftDatabaseProvider = MyDriftDatabaseProvider._();

final class MyDriftDatabaseProvider
    extends
        $FunctionalProvider<
          AsyncValue<MyDriftDatabase>,
          MyDriftDatabase,
          FutureOr<MyDriftDatabase>
        >
    with $FutureModifier<MyDriftDatabase>, $FutureProvider<MyDriftDatabase> {
  const MyDriftDatabaseProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
  ...
  @override
  String debugGetCreateSourceHash() => _$myDriftDatabaseHash();

  @$internal
  @override
  $FutureProviderElement<MyDriftDatabase> $createElement(
    $ProviderPointer pointer,
  ) => $FutureProviderElement(pointer);

  @override
  FutureOr<MyDriftDatabase> create(Ref ref) {
    return myDriftDatabase(ref);
  }
}

String _$myDriftDatabaseHash() => r'dcb66edf95cdc7e1ec26a21945794c44d3d26dca';
